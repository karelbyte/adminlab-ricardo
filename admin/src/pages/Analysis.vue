      ...
      <q-card style="width: 100%">
        ...
        <div class="row">
          <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 q-pa-sm">
            <q-input dense outlined autofocus v-model="item.code" label="Codigo" class="q-mb-sm text-uppercase"/>
          </div>
          <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 q-pa-sm">
            <q-input dense outlined  v-model="item.description" label="Descripción" class="q-mb-sm text-uppercase"/>
          </div>
          <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 q-pa-sm">
...
export default {
  ...
  methods: {
    ...
    analisisShow (id) {
      window.open('/analysis/pdf/' + id, '_blank')
    },
    editItemDetail (it) {
