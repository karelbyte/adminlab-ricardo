  ...
  <q-page class=" q-pa-md">
    ...
    <q-dialog v-model="showForm" persistent transition-show="scale" transition-hide="scale">
      <q-card  style="width: 700px; max-width: 80vw;">
        ...
        <q-separator/>
        <q-card-section>
          <q-input ref="name" dense outlined autofocus v-model="item.names" label="Lugar" class="q-mb-xs text-uppercase"/>
          <q-input dense outlined type="text" v-model="item.symbol" label="Nomenclatura" class="q-mb-sm text-uppercase"/>
...
export default {
  ...
  methods: {
    openInfo (item) {
      let url = ApiUrl + '/locations/info/' + item.id
